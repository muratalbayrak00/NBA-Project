...
def find_score_result(game_id):
    # Dosya yolu
    game_id = int(game_id)
    file_path = "Row_data/shots_fixed.csv"
    ...
    # Ev sahibi ve rakip takımı belirle
        # Eğer filtrelenmiş DataFrame boşsa, hata vermeden None döndür
    if df_filtered.empty:
        print(f"Hata: {game_id} ID'li maç için veri bulunamadı!")
